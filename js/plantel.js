// js/plantel.js
import { CATEGORIAS_DISPONIBLES, NOMBRES_CATS, MAX_POR_CATEGORIA, ORDEN_CATS } from './constants.js';

export const renderPlantelSlots = (plantelActual, onSlotClick, onEdit, onDelete) => {
    return (
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: '20px' }}>
            {ORDEN_CATS.map(catKey => {
                // Validación de seguridad: si la categoría no existe en el objeto, usamos array vacío
